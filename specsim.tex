...
% obscuration value from: https://arxiv.org/pdf/astro-ph/0602326.pdf
...
Camera data was derived separately for the red and blue cameras using data from real eBOSS spectra. The \pkg{bossdata} software package \cite{bossdata} was used to download data from the Sloan Digital Sky Survey (SDSS) Sky Server, and was part of version \pkg{v5\_9\_0} of Data Release 13, the first data release of the fourth phase of SDSS (SDSS-IV). Data was pulled from 20 random plates, each observed on a different day, for all four cameras (two blue cameras, b1 and b2, and two red cameras, r1 and r2). 
...
The wavelength solution, dispersion and FWHM resolution for each fiber were accessed from \pkg{spCFrame} files. These files contain flux-calibrated spectra for a single camera of a single exposure. The dispersion was determined by taking the gradient of the wavelength solution with respect to pixel number. The FWHM resolution was provided in the files and converted from units of 10$^{-4}$ log10($\mbox{\AA}$) to Angstroms.
...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/specsim/throughput_7027_56448.png}
            \caption[Network2]%
            {{\small Network 1}}    
            \label{fig:thru1}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{images/specsim/throughput_7517_56772.png}
            \caption[]%
            {{\small Network 2}}    
            \label{fig:thru2}
        \end{subfigure}
...
\subsubsection{Additional configuration data}
...
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.3]{images/specsim/extinction.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.3]{images/specsim/sky_brightness.png}}
\end{minipage}\par\medskip
\centering
\subfloat[]{\label{main:c}\includegraphics[scale=.3]{images/specsim/source.png}}
\caption{Adjusted additional data.}
\label{fig:adjusted}
\end{figure}

\subsection{Verification of the eBOSS configuration}
